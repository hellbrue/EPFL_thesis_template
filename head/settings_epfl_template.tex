...
\addbibresource{tail/bib_thesis_lukas_manuel.bib}
...
%%%%% CHAPTER HEADER %%%%
\usepackage[x11names,table,rgb,cmyk]{xcolor}
% \usepackage{color}
\usepackage{tikz}
\usepackage[explicit]{titlesec}
\definecolor{epfl_red}{RGB}{255, 0, 0}
\newcommand{\chaptercolor}{epfl_red} % default color for chapter rectangle
...
\titleformat{\chapter}[display]  % type (section,chapter,etc...) to vary,  shape (eg display-type)
    ...
    \node[yshift=-8cm] at (current page.north west)
      {\begin{tikzpicture}[remember picture, overlay]
        \draw[fill=\chaptercolor, draw=none] (0,0) rectangle(35.5mm,15mm);

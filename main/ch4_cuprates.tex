...
\begin{figure}
	...
	\caption{Crystal structure of single-, bi-, and tri-layer \ce{Bi}-based cuprates \ce{Bi2Sr2Ca_{n-1}Cu_nO_{4+2n}} (\ce{Bi2201}, \ce{Bi2212}, and \ce{Bi2223}). Adapted from Ref. \cite{nazargulov_english_2009}.}
...
\begin{figure}[t]
	...
	\begin{subfigure}[b]{0.45\textwidth}
		...
		\caption{}
	\end{subfigure}
	\caption{(a) Sketch of the phase diagram of hole-doped cuprates. Adapted from Ref. \cite{keimer_quantum_2015}. (b) Sketch of the Fermi surface of \ce{Bi2212}, with the red line representing the momentum-dependent gap magnitude, corresponding to the d-wave symmetry. Adapted from Ref. \cite{zhang_photoinduced_2017}.}
...
\begin{figure}
	...
	\caption{Electrical resistance of the \ce{Bi2212} sample used in the experiment. The superconducting transition temperatures are $T_{c,\text{onset}} = \qty{92.3}{\kelvin}$, $T_{c,\text{50\%}} = \qty{90.1}{\kelvin}$, and $T_{c,\text{zero}} = \qty{85.7}{\kelvin}$.}
...
\begin{figure}[t]
	...
	\caption{Fermi surface of \ce{Bi2212} as shown in Fig. \ref{fig:fs_cut}. The black dashed lines indicate the series of cuts along which fluence dependence was recorded.}
...
\begin{figure}
	...
	\caption{Schematic of the \ce{CuO} plaquette, which plays a central role in the electronic properties of \ce{Bi2212}. The key microscopic charge properties responsible for changes in the Fermi surface (FS) are also indicated, including the Coulomb potential $U$, the charge transfer energy (CT), and the nearest and next-nearest neighbor hopping parameters $t$ and $t'$.}
...
\begin{figure}[b!]
	...
	\begin{subfigure}[t!]{0.33\textwidth}
		...
		\caption{}
	\end{subfigure}
	\caption{(a) Tight binding Fermi surface (FS) for a fluence of \qty{0.09}{\milli\joule/\centi\meter\squared}, shown alongside optimally doped \ce{Bi2212} literature data from Ref. \cite{kondo_hole-concentration_2004}. (b) Tight binding FS for all measured fluences. The full FS is recreated using the material's four-fold symmetry, with the measured data points marked accordingly.}
	\label{fig:fs_tb}
\end{figure}

...
Fig. \ref{} shows they crystal structure for the single-, bi- and trilayer \ce{Bi}-based cuprates.
...
In this case the charge transfer gap between the \ce{O} $2p$ and the \ce{Cu} $3d$ orbital is smaller, hence the classification as a Charge-Transfer insulator. 

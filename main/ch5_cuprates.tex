...
Superconductors have fascinated since the first observation of a zero drop in resistivity and the observation of perfect diamagnetism in the materials. \cite{}
After many discoveries on these early superconductors, both experimentally and theoretical, even a theory was found that could explain the microscopic origin of these materials.
This theory by Bardeen, Cooper and Schriefer, called the BCS-theory, is based on the existence of an attractive force, that enables the pairing of charges into Cooper-pairs and their subsequent condensation.
For the BCS superconductors this force is established by phonons.
With the knowledge of the BCS theory, it was possible to engineer better superconductors, by oncsidering the building blocks of strong electron-phonon coupling and check notes!! and push their critical temperature higher and higher.
...
Instead, in year the first high temperature superconductor was found by Berdnoz and Müller.
...
Many different classes of these high $T_c$, or rather unconventional, superconductors have been found this far, among them are the Iron-pnictides, carbon based, heavy-fermion based, hydrides, nickelates and the cuprate superconductors, which were the first high $T_c$ superconductors found by Berdnoz and Müller.
...
The first among them was the resonating valence bond (RVB) theory.
The concept was first proposed for metals and molecular interactions by Pauling, and then extended to the superconductors by Anderson.
...
Another theory is based on antiferromagnetic fluctuations mediating the pairing to Cooper pairs \cite{} 144.
Different from the RVB approach, the formation of pairs is mediated by the exchange of particle-hole fluctuations.
The initial development was based on observations made by neutron scattering experiments \cite{}. 146-149
It is now largely accepted that antiferromagnetic fluctuations and superexchange interactions play an important role in the creation of superconductivity, with recent reports showing experimental evidence in this regard \cite{} 154 155.
...
Here observation of near room temperature superconductivity have been made at extreme pressures in the \unit{\giga\pascal} range.
...
In recent years groundbreaking experiments have shown first indications of light induced superconductivity.
...
In this case the charge transfer gap between the \ce{O} $2p$ and the \ce{Cu} $3d$ orbital is smaller, hence the classification as a Charge-Transfer insulator \cite{zaanen_band_1985} fra 63. 
...
Adding a small amount of holes to the compound, results in the delocalization of this hole and the formation of the Zhang-Rice singlet (ZRS), which is located at the Fermi-level. (see Fig. \ref{fig:cuo_dos}).
...
The superconducting (SC) phase in cuprates shows anisotropic $d$-wave symmetry, which has been observed experimentally by various techniques \cite{} 102-113 anme techniques + recent arpes sign change gap.
...
The anisotropic $d$-wave symmetry of the gap stands in contrast to the $s$-wave gap symmetry of the BCS superconductors \cite{} fra 7, which show a full gapping across the Brillouin zone.
...
Similar to the SC phase a microscopic explanation on the formation of the pseudogap is missing, but the evidence points towards a connection to short-range antiferromagnetic correlations \cite{} fra 38.
...
In this phase, the resistivity of the material shows a perfectly linear dependence on the temperature, up to a specific temperature which is up to a few hundreds of kelvin, in the case of cuprates \cite{} fra 39-41.
The strange metal phase is not exclusive to hole doped cuprates, but is found in a plethora of material classes.
The strange metal behavior typically occurs in the proximity of a quantum critical point \cite{} fra 41,43,44, and is associated with the phenomenon of Planckian dissipation, which shows that the inelastic scattering time $\tau$ is inversely proportional to the temperature with
\begin{equation}
	\tau \approx \frac{\hbar}{k_BT}
\end{equation}
where $\hbar$ is the Planck constant and $k_B$ the Boltzmann constant \cite{ataei_electrons_2022}, fra 47.
...
The competition of the charge order and superconductivity is very active research field and of high importance for understanding the mechanisms behind high $T_c$ superconductivity \cite{} fra 59.
...
The three-band Hubbard model (sometimes called Emery model) can describe the contributions from the multiple orbitals as well as their interaction\cite{avella_emery_2013} fra 61 62.
...
This problem can then be reduced to a single-band Hamiltonian, that expresses the interactions of the electrons on the copper sites by a superexchange, mediated by the oxygen orbitals \cite{} 65 66 67.
...
Zhang and Rice showed that due to the presence of an added hole, a singlet state emerges, and that the occupation of this state is energetically favored \cite{} fra 66.
...
By performing ARPES measurements on the cuprates, the parameters of this model can be estimated by fitting the Fermi surface \cite{} fra 69.

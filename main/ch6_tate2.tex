...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{images/tate2/commensurate}
	\caption{The figure shows two 1D atomic chains together with a commensurate (top) and incommensurate (bottom) charge density.}
